        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="space-y-1">
            ...
            <div id="furniture">
              <Link
                to="/furniture/1"
                className="block relative overflow-hidden group w-full mb-1"
              >
                <div className="relative h-[60vh] lg:h-[70vh] overflow-hidden">
                  <img
                    src="https://cdn.poehali.dev/projects/225e8d36-abe0-4bfc-92a7-a7816ca7b2fc/files/2442bbfd-afb1-4946-8077-eea71e91c311.jpg"
                    alt="Коллекция мебели для фабрики FOCUS.39"
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                  <div className="absolute bottom-8 left-8 z-10">
                    <h3 className="text-3xl lg:text-4xl font-light text-white tracking-wide">
                      Коллекция мебели для фабрики FOCUS.39
                    </h3>
                  </div>
                </div>
              </Link>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-1">
                ...
                >
                  <img
                    src="https://cdn.poehali.dev/projects/225e8d36-abe0-4bfc-92a7-a7816ca7b2fc/files/33581fb3-b40c-4816-8db9-e2a8c5811d3d.jpg"
                    alt="Торшеры и зеркала"
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                  <div className="absolute bottom-6 left-6 z-10">
                    <h3 className="text-xl font-light text-white tracking-wide">Торшеры и зеркала</h3>
                  </div>
                </Link>
                ...
                >
                  <img
                    src="https://cdn.poehali.dev/projects/225e8d36-abe0-4bfc-92a7-a7816ca7b2fc/files/a08ab1f5-8a51-4081-a631-f293a26b55f6.jpg"
                    alt="Стеллажи"
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                  <div className="absolute bottom-6 left-6 z-10">
                    <h3 className="text-xl font-light text-white tracking-wide">Стеллажи</h3>
                  </div>
                </Link>
                ...
                >
                  <img
                    src="https://cdn.poehali.dev/projects/225e8d36-abe0-4bfc-92a7-a7816ca7b2fc/files/8ab6c3b7-e13f-4641-962a-d7772527587b.jpg"
                    alt="Комоды"
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                  <div className="absolute bottom-6 left-6 z-10">
                    <h3 className="text-xl font-light text-white tracking-wide">Комоды</h3>
                  </div>
                </Link>
                ...
                >
                  <img
                    src="https://cdn.poehali.dev/projects/225e8d36-abe0-4bfc-92a7-a7816ca7b2fc/files/8e8c7a2b-5427-4b5c-bb66-fd4d931c05d0.jpg"
                    alt="Столы и стулья"
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                  <div className="absolute bottom-6 left-6 z-10">
                    <h3 className="text-xl font-light text-white tracking-wide">Столы и стулья</h3>
                  </div>
                </Link>
                ...
                >
                  <img
                    src="https://cdn.poehali.dev/projects/225e8d36-abe0-4bfc-92a7-a7816ca7b2fc/files/e25dbe24-ba7d-4f7d-8826-4a2391a5ee15.jpg"
                    alt="Столики"
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                  <div className="absolute bottom-6 left-6 z-10">
                    <h3 className="text-xl font-light text-white tracking-wide">Столики</h3>
                  </div>
                </Link>
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                  <div className="absolute bottom-6 left-6 z-10">
                    <h3 className="text-xl font-light text-white tracking-wide">Проект 7</h3>
                  </div>
                </Link>
              </div>
            </div>
